...
(function (factory) {
    ...
    var setMovement = {
        ...
        transform: function (offset, factor, windowHeight, height) {
            return Math.round((offset - (windowHeight / 1) + height) * factor);
        }
    };
    ...
    $.fn.paroller = function (options) {
        ...
        return this.each(function () {
            ...
            $(window).on('resize', function () {
                ...
                transform = Math.round((offset - (windowHeight / 1) + height) * factor);
            ...
            $(window).on('scroll', function () {
                ...
                transform = Math.round(((offset - (windowHeight / 1) + height) - scrolling) * factor);
